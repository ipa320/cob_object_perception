...
static const double ROT_FACTOR = 32.0; // PI * ROT_FACTOR = 0.1 m
...
public:
	...
	/// @param A the argument vector 
	/// @return the angle
	double GetAngle(const Point3Dbl& A) const {return acos(GetCosine(A));}
	//{Point3Dbl Tmp; Tmp.VectorProd(*this, A); return atan2(Tmp.AbsVal(), ScalarProd(A));} 
...
///// Cylinder function: returns true if a point is in the cylinder
//bool IsInCylinder(const Point3Dbl& S0, const Point3Dbl& S1, const Point3Dbl& Q, double R);
//
//
...
public:
	...
	/// Get a conversion frame from three matches. Gets the coordinate transformation without knowing the orig�n points. 
	/// Not implemented.
...
///// A struct that represents a coordinate frame and a scalar. 
//class FrameStruct
//{
//public:
//	FrameStruct(){};
